...
// Good practice is to declare an empty array and then add elements using the syntax below
// NB here, the items have been given specific keys - 10 start for book, 20 for movies and 30 for music
$catalog = [];
$catalog[101] = [
